import { IBodyGuardia } from 'cda-guardia-heller/schemas/bodyGuardia';
import { getPacienteAndes } from '../services/paciente';

let moment = require('moment');

export async function verificar(registro: IBodyGuardia, token: any) {

    let dto: IBodyGuardia = {
        id: registro.id,
        paciente: null,
        profesional: null,
        fecha: null,
...
async function vPaciente(registro: IBodyGuardia, token: any) {
    let paciente = {
...
function vProfesional(registro: IBodyGuardia) {
    let profesional = {
