...
function make(paciente: any) {
    const connectionString = {
        user: ConfigPrivate.staticConfiguration.piedra.user,
        password: ConfigPrivate.staticConfiguration.piedra.password,
        server: ConfigPrivate.staticConfiguration.piedra.ip,
        database: ConfigPrivate.staticConfiguration.piedra.database,
