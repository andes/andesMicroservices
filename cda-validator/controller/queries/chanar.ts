...
function make(paciente: any) {
    const connectionString = {
        user: ConfigPrivate.staticConfiguration.chanar.user,
        password: ConfigPrivate.staticConfiguration.chanar.password,
        server: ConfigPrivate.staticConfiguration.chanar.ip,
        database: ConfigPrivate.staticConfiguration.chanar.database,
