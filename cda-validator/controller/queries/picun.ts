...
function make(paciente: any) {
    const connectionString = {
        user: ConfigPrivate.staticConfiguration.picun.user,
        password: ConfigPrivate.staticConfiguration.picun.password,
        server: ConfigPrivate.staticConfiguration.picun.ip,
        database: ConfigPrivate.staticConfiguration.picun.database,
